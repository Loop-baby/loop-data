...
python sync_quickbase.py --qb_table_name products --schema_name shopify --dw_table_name products --to_quickbase
...
echo "extracting reviews.io"
python sync_reviewsio.py
